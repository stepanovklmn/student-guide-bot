...
# Скрываем брендинг Streamlit: footer, бейдж, кнопки Fork/GitHub/Deploy.
# Оставляем только переключатель темы (light/dark/system).
st.markdown("""
<style>
    /* Нижний колонтитул и бейдж "Made with Streamlit" */
    footer {visibility: hidden; height: 0;}
    [data-testid="stToolbar"] {display: none !important;}
    [data-testid="stDecoration"] {display: none !important;}
    [data-testid="stStatusWidget"] {display: none !important;}

    /* Кнопки Fork, GitHub, Deploy, меню в правом верхнем углу */
    .stAppDeployButton {display: none !important;}
    [data-testid="stAppDeployButton"] {display: none !important;}
    [data-testid="stMainMenu"] {display: none !important;}
    #MainMenu {visibility: hidden;}

    /* Нижний правый блок со ссылкой на Streamlit Cloud */
    ...
    /* Убираем нижний отступ, который оставлял бейдж */
    .main .block-container {padding-bottom: 0 !important;}
    .stApp {padding-bottom: 0 !important;}

    /* Восстанавливаем только переключатель темы в правом верхнем углу */
    ...
    [data-testid="stToolbar"] [data-testid="stThemeSwitcher"] {
        display: block !important;
    }
</style>
