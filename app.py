...
# ---- Скрываем нижний бейдж Streamlit + ссылку на автора ----
st.markdown("""
<style>
    /* Современные data-testid-селекторы */
    ...
    /* Устаревшие классы (на случай старых версий Streamlit) */
...
# ---- JS-фолбэк: если бейдж рендерится позже или внутри shadow-DOM ----
components.html("""
<script>
    function hideBadge() {
    ...
    hideBadge();
    // На случай, если Streamlit перерисует DOM
